...
#include "../../data_holders/pixel_data_translator.h"

#define INPUT_WIDGETS_WIDTH_HEIGHT 700

/*************************
 * ABSTRACT INPUT WIDGET *
 *************************/
InputWidget::InputWidget(PixelData * pixel_data, int min, int max, QString label, QString unit, QWidget *parent)
    : QWidget(parent), m_width(INPUT_WIDGETS_WIDTH_HEIGHT), m_height(INPUT_WIDGETS_WIDTH_HEIGHT), m_min(min), m_max(max), m_label(label),
      m_drawing(false), m_pixel_data(pixel_data), m_container_label(INPUT_WIDGETS_WIDTH_HEIGHT, INPUT_WIDGETS_WIDTH_HEIGHT),
 ...
 * SOIL HUMIDITY *
 *****************/
SoilHumidityInputWidget::SoilHumidityInputWidget( QWidget * parent ) : InputWidget(new PixelData(new SoilHumidityTranslator, INPUT_WIDGETS_WIDTH_HEIGHT, INPUT_WIDGETS_WIDTH_HEIGHT),
                                                                                         0,100, "Humidity:", "%", parent) {}
/****************
 * ILLUMINATION *
 ****************/
IlluminationInputWidget::IlluminationInputWidget( QWidget * parent ) : InputWidget(new PixelData(new IlluminationTranslator, INPUT_WIDGETS_WIDTH_HEIGHT, INPUT_WIDGETS_WIDTH_HEIGHT),
                                                                                         0,24, "Illumination:", "hours", parent) {}

/***************
 * TEMPERATURE *
 ***************/
TemperatureInputWidget::TemperatureInputWidget( QWidget * parent ) : InputWidget(new PixelData(new TemperatureTranslator, INPUT_WIDGETS_WIDTH_HEIGHT, INPUT_WIDGETS_WIDTH_HEIGHT),
